"""
Django settings for salon_scheduler_pro_45514 project.
...
ROOT_URLCONF = 'salon_scheduler_pro_45514.urls'
...
WSGI_APPLICATION = 'salon_scheduler_pro_45514.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "salon_scheduler_pro_45514 API",
    "DESCRIPTION": "API documentation for salon_scheduler_pro_45514 App",
    "VERSION": "v1",
}
